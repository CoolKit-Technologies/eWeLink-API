...
- Business-verified partners and enterprises that have purchased APPID through payment, the total call times for all interfaces requested using the 'Paid APPID' are limited to 6 million times per year (support for overage expansion, please contact bd@coolkit.cn for details), and the limit on the frequency of calls within a short period is consistent with the first point mentioned above.
