...
- Business-verified partners and enterprises that have purchased APPID through payment, the total number of API calls using the 'Paid APPID' is limited to 6 million times per year (supports overage expansion, please contact bd@coolkit.cn for details), and the frequency limit is consistent with the second point mentioned above.
